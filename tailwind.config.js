...
// Abirikky — brand tokens: gold #C8951C · green #3DB53A · cream #EDD9A3 · dark #1C1C1A
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Primary — logo wordmark & utensils
        gold: {
          50: "#FDFBF2",
          100: "#FAF3D6",
          200: "#F5E4A3",
        ...
        // Secondary — logo swirl flourishes
        green: {
          50: "#F2FCF2",
          100: "#DCFADC",
          200: "#AAEAAA",
        ...
        // Warm parchment — logo tagline & section tints
        cream: {
          50: "#FFFDFB",
          100: "#FFF8F0",
          200: "#FFF0DC",
        ...
        // Text & foreground only — never use as background
        charcoal: {
          50: "#F5F5F4",
          100: "#E7E6E3",
          200: "#CBC9C3",
          ...
          500: "#4A453E",
          600: "#2E2A23",
          700: "#1C1C1A", // ★ headings & icons
          800: "#141412",
          900: "#0A0A08",
        },

        // Background surfaces — white-first, use these for all bg
        surface: {
          page: "#FFFFFF",
          body: "#FDFCFB",
          warm: "#FFF8F0",
